(function(window, undefined) {
    ...
    var TempusDate = function( options ) {
        ...
        this.milliseconds = function(value) {
            if (arguments.length !== 0) {
                if (typeof value === 'number' || typeof value === 'string') {
        ...
        */
        ...
        this.between = function(dateTo, type) {
        ...
        // TP.parse(new Date()).get()
        this.parse = function(str, format, defaults) {
         ...
         */
        this.iWantUseMilliseconds = function(value) {
         ...
         * TP.set({year: 2013, month: 11, day: 14}).format('%d %B %Y');
         */
        this.iLoveMonthFromZero = function(value) {
         ...
         */
        this.asVanillaDateUTC = function() {
